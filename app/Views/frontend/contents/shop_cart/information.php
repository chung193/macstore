...
<html lang="en-US" dir="ltr" class="no-js windows chrome desktop page--no-banner page--logo-main page--show page--show card-fields">
  <head>
    ...
    <title>    Payment - astor - Checkout</title>
...
<meta property="og:title" content="Purchase New Watch Series Black" />
<meta property="og:image" content="https://cdn.shopify.com/s/files/1/0023/4104/4283/products/28_b79dc524-d48e-404d-8384-0358251f2d03_1024x1024.png?v=1643625211" />
...
<!--<![endif]-->
  ...
  Shopify.Checkout.apiHost = "bigon-6.myshopify.com";
  ...
  Shopify.Checkout.token = "81c18273175153061f893380e93bcaa7";
  Shopify.Checkout.currency = "USD";
  Shopify.Checkout.estimatedPrice = 999.00;
  Shopify.Checkout.dynamicCheckoutPaymentInstrumentsConfig = {"paymentInstruments":{"accessToken":"46173f49bb44e42a9e32d0d631769a12","amazonPayConfig":null,"applePayConfig":null,"checkoutConfig":{"domain":"bigon-6.myshopify.com","shopId":2341044283},"shopifyPayConfig":null,"currency":"USD","googlePayConfig":null,"locale":"en-US","paypalConfig":null,"offsiteConfigs":null,"supportsDiscounts":false,"supportsGiftCards":false,"checkoutDisabled":false}};
  Shopify.Checkout.applePayConfig = null;
  Shopify.Checkout.hasSellingPlan = false;
  Shopify.Checkout.requiresConfirmationStep = false;
  Shopify.Checkout.cartToken = "ca857c3f224dfa7d197132c631ecc20e";
  Shopify.Checkout.countriesUrl = null;
  Shopify.Checkout.isCheckoutOne = true; // Default to true
  ShopifyExperiments.AutocompleteServiceApiHost = "https:\/\/atlas.shopifycloud.com";
  ShopifyPay.enabled = false;
  ShopifyPay.apiToken = "QmliY0J0QWErMm9ZbzZVVUtUK1BQRFNqeVREME1iT1BHNW1haVY2cUUvZjlUY1dMemJJNENqcGJPdTFPVnRHOS0tbEdtY2h5cFlEZUVFZUZLam1CTWdYUT09--67cd116c9a529987c1affd7b550cd66594fda1ac";
  ...
  <script>
    ...
    ShopifyExperiments.peruAutocompletion = false;
    ShopifyExperiments.chileAutocompletion = false;
    ShopifyExperiments.portugalAutocompletion = false;
    ShopifyExperiments.finlandAutocompletion = false;

    if (ShopifyExperiments.peruAutocompletion) {
      Shopify.autocompleteEnabledCountries.push("PE").to_json;
    }

    if (ShopifyExperiments.chileAutocompletion) {
      Shopify.autocompleteEnabledCountries.push("CL").to_json;
    }

    if (ShopifyExperiments.portugalAutocompletion) {
      Shopify.autocompleteEnabledCountries.push("PT").to_json;
    }

    if (ShopifyExperiments.finlandAutocompletion) {
      Shopify.autocompleteEnabledCountries.push("FI").to_json;
    }
  </script>
...
<script src="//cdn.shopify.com/shopifycloud/shopify/assets/checkout-01727298a67252103e047b8cb9ab3b59505a7bcdab06c3cbdb2583df499b077b.js" crossorigin="anonymous"></script>
  ...
  <script src="https://checkout.shopifycs.com/dist/card_fields.js"></script>
...
<script type="text/javascript">
  ...
  var DF_CHECKOUT_TOKEN = "81c18273175153061f893380e93bcaa7";
</script>
...
<script id="__st">var __st={"a":2341044283,"offset":-14400,"reqid":"f17bd827-b604-4074-9999-2394618ca1cb","pageurl":"bigon-6.myshopify.com\/2341044283\/checkouts\/81c18273175153061f893380e93bcaa7","u":"6f59db76ddb1","t":"checkout","offsite":1};</script>
...
<script>
  Shopify.Checkout.safeForDbAutocomplete = true;
</script>
    ...
    <span class="wrap">
      <span class="order-summary-toggle__inner">
        ...
        <dl class="order-summary-toggle__total-recap total-recap" data-order-summary-section="toggle-total-recap">
          ...
          <dd>
            <span class="order-summary__emphasis total-recap__final-price skeleton-while-loading" data-checkout-payment-due-target="101900">$1,019.00</span>
            </dd>
        </dl>
      </span>
    </span>
...
<h1 class="visually-hidden">
  Payment
    ...
    <ol class="breadcrumb " role="list">
        <li class="breadcrumb__item breadcrumb__item--completed">
          <a class="breadcrumb__link" href="https://bigon-6.myshopify.com/cart">Cart</a>
          ...
          <li class="breadcrumb__item breadcrumb__item--completed">
          <a class="breadcrumb__link" href="/2341044283/checkouts/81c18273175153061f893380e93bcaa7?step=contact_information">Information</a>
            <svg class="icon-svg icon-svg--color-adaptive-light icon-svg--size-10 breadcrumb__chevron-icon" aria-hidden="true" focusable="false"> <use xlink:href="#chevron-right" /> </svg>
        </li>
          <li class="breadcrumb__item breadcrumb__item--completed">
          <a class="breadcrumb__link" href="/2341044283/checkouts/81c18273175153061f893380e93bcaa7?step=shipping_method">Shipping</a>
            <svg class="icon-svg icon-svg--color-adaptive-light icon-svg--size-10 breadcrumb__chevron-icon" aria-hidden="true" focusable="false"> <use xlink:href="#chevron-right" /> </svg>
        </li>
  ...
  GoogleAnalyticsSandbox.sandboxToken = "i7008UiTiBIW1zM4BxYqQw";
})();
</script>
<iframe srcdoc="<script>(function() {
  Shopify = window.Shopify || {};
  Shopify.Checkout = window.Shopify.Checkout || {};
  Shopify.Checkout.allowlistedUrls = [&quot;https:\/\/bigon-6.myshopify.com&quot;,&quot;https:\/\/bigon-6.account.myshopify.com&quot;,&quot;https:\/\/checkout.shopify.com&quot;];
  Shopify.Checkout.allowlistedHostSuffixes = [&quot;-2341044283.shopifypreview.com&quot;];
  GoogleAnalyticsSandbox = window.GoogleAnlyticsSandbox || {};
  GoogleAnalyticsSandbox.sandboxToken = &quot;i7008UiTiBIW1zM4BxYqQw&quot;;
})();
</script>
...
</script>" src="https://checkout.shopify.com/2341044283/sandbox/google_analytics_iframe?sandbox_token=i7008UiTiBIW1zM4BxYqQw" onload="this.setAttribute(&#39;data-loaded&#39;, true)" sandbox="allow-scripts" id="google-analytics-sandbox" tabIndex="-1" class="visually-hidden" style="display:none" aria-hidden="true"></iframe>
...
<div class="step" data-step="payment_method" data-last-step="true">
  ...
  <div class="review-block__inner">
    ...
    <div role="cell" class="review-block__content">
      <bdo dir="ltr">+84 796 496 199</bdo>
    </div>
  </div>
    <div role="cell" class="review-block__link">
      <a class="link--small" href="/2341044283/checkouts/81c18273175153061f893380e93bcaa7?step=contact_information">
  ...
  <div class="review-block__inner">
    ...
    <div role="cell" class="review-block__content">
        <address class="address address--tight">
          Hai Phong, Hai Phong 1800000, Vietnam
        </address>
    </div>
  </div>
      <div role="cell" class="review-block__link">
...
<div role="row" class="review-block">
  <div class="review-block__inner">
    ...
    <div role="cell" class="review-block__content" data-review-section="shipping-cost">
        ...
        <strong class="emphasis">
          <span class="skeleton-while-loading--inline">$20.00</span>
        </strong>
    ...
    <form class="edit_checkout" data-payment-form="" action="/2341044283/checkouts/81c18273175153061f893380e93bcaa7" accept-charset="UTF-8" method="post"><input type="hidden" name="_method" value="patch" autocomplete="off" /><input type="hidden" name="authenticity_token" value="OIajAbcUFuRrzBOYNYFIA1r-NNhhMR-REa_34xSe7XZo18A0Xh3tgu470upoxboqxX1pZ7uezk5G8ppZj8l_9w" autocomplete="off" />
      <input type="hidden" name="previous_step" id="previous_step" value="payment_method" autocomplete="off" />
      <input type="hidden" name="step" autocomplete="off" />
  ...
  <div class="section__content">
    ...
    data-select-gateway="8532557883"
    data-submit-i18n-key="complete_order">
      <input value="8532557883" autocomplete="off" size="30" type="hidden" name="checkout[payment_gateway]" />
    ...
    <div id="payment_gateway_8532557883_description" class="visually-hidden" aria-live="polite" data-detected="Detected card brand: {brand}">
</div>  </div>
    ...
    <div class="section__content">
          <fieldset class="content-box">
            ...
            <div class="radio-wrapper content-box__row" data-different-billing-address>
              <div class="radio__input">
                <input class="input-radio" data-backup="different_billing_address_true" aria-controls="section--billing-address__different" type="radio" value="true" name="checkout[different_billing_address]" id="checkout_different_billing_address_true" />
              </div>
  ...
  <input class="visually-hidden" autocomplete="billing given-name" tabindex="-1" aria-hidden="true" aria-label="no-label" data-autocomplete-field="first_name" data-honeypot="true" size="30" type="text" name="checkout[billing_address][first_name]" />
  <input class="visually-hidden" autocomplete="billing family-name" tabindex="-1" aria-hidden="true" aria-label="no-label" data-autocomplete-field="last_name" data-honeypot="true" aria-required="true" size="30" type="text" name="checkout[billing_address][last_name]" />
  
  <input class="visually-hidden" autocomplete="billing address-line1" tabindex="-1" aria-hidden="true" aria-label="no-label" data-autocomplete-field="address1" data-honeypot="true" aria-required="true" size="30" type="text" name="checkout[billing_address][address1]" />
  <input class="visually-hidden" autocomplete="billing address-line2" tabindex="-1" aria-hidden="true" aria-label="no-label" data-autocomplete-field="address2" data-honeypot="true" size="30" type="text" name="checkout[billing_address][address2]" />
  <input class="visually-hidden" autocomplete="billing address-level2" tabindex="-1" aria-hidden="true" aria-label="no-label" data-autocomplete-field="city" data-honeypot="true" aria-required="true" size="30" type="text" name="checkout[billing_address][city]" />
  <input class="visually-hidden" autocomplete="billing country" tabindex="-1" aria-hidden="true" aria-label="no-label" data-autocomplete-field="country" data-honeypot="true" aria-required="true" size="30" type="text" name="checkout[billing_address][country]" />
  <input class="visually-hidden" autocomplete="billing address-level1" tabindex="-1" aria-hidden="true" aria-label="no-label" data-autocomplete-field="province" data-honeypot="true" aria-required="true" size="30" type="text" name="checkout[billing_address][province]" />
  <input class="visually-hidden" autocomplete="billing postal-code" tabindex="-1" aria-hidden="true" aria-label="no-label" data-autocomplete-field="zip" data-honeypot="true" aria-required="true" size="30" type="text" name="checkout[billing_address][zip]" />
  



  <div class="field--half field field--optional" data-address-field="first_name">
    <label class="field__label" for="checkout_billing_address_first_name">First name (optional)</label>
    <div class="field__input-wrapper">
      <input placeholder="First name (optional)" autocomplete="billing given-name" autocorrect="off" data-backup="first_name" class="field__input" size="30" type="text" name="checkout[billing_address][first_name]" id="checkout_billing_address_first_name" />
    </div>
</div>
  <div class="field--half field field--required" data-address-field="last_name">
    ...
    <div class="field__input-wrapper">
      <input placeholder="Last name" autocomplete="billing family-name" autocorrect="off" data-backup="last_name" class="field__input" aria-required="true" size="30" type="text" name="checkout[billing_address][last_name]" id="checkout_billing_address_last_name" />
    </div>
</div>
  ...
  <div data-address-field="address1" data-autocomplete-field-container="true" class="field field--required">
    ...
    <div class="field__input-wrapper">
        <input placeholder="Address" autocomplete="billing address-line1" autocorrect="off" data-backup="address1" class="field__input" aria-required="true" size="30" type="text" name="checkout[billing_address][address1]" id="checkout_billing_address_address1" />
    ...
    <div data-address-field="address2" data-autocomplete-field-container="true" class="field field--optional">
      <label class="field__label" for="checkout_billing_address_address2">Apartment, suite, etc. (optional)</label>
      <div class="field__input-wrapper">
        <input placeholder="Apartment, suite, etc. (optional)" autocomplete="billing address-line2" autocorrect="off" data-backup="address2" class="field__input" size="30" type="text" name="checkout[billing_address][address2]" id="checkout_billing_address_address2" />
      </div>
</div>
  <div data-address-field="city" data-autocomplete-field-container="true" class="field field--required">
    ...
    <div class="field__input-wrapper">
      <input placeholder="City" autocomplete="billing address-level2" autocorrect="off" data-backup="city" class="field__input" aria-required="true" size="30" type="text" name="checkout[billing_address][city]" id="checkout_billing_address_city" />
    </div>
</div>
  <div class="field--third field field--required" data-address-field="country" data-autocomplete-field-container="true">
    <label class="field__label" for="checkout_billing_address_country">Country/region</label>
    <div class="field__input-wrapper field__input-wrapper--select">
      <select size="1" autocomplete="billing country" data-backup="country" class="field__input field__input--select" aria-required="true" name="checkout[billing_address][country]" id="checkout_billing_address_country"><option data-code="VN" selected="selected" value="Vietnam">Vietnam</option>
...
<option data-code="ZW" value="Zimbabwe">Zimbabwe</option></select>
  ...
  <div class="field--third field field--required" data-address-field="province" data-autocomplete-field-container="true">
    <label class="field__label" for="checkout_billing_address_province">Region</label>
    <div class="field__input-wrapper field__input-wrapper--select">
      <input placeholder="Region" autocomplete="billing address-level1" autocorrect="off" data-backup="province" class="field__input" aria-required="true" type="text" name="checkout[billing_address][province]" id="checkout_billing_address_province" />
  ...
  <div class="field--third field field--required" data-address-field="zip" data-autocomplete-field-container="true">
    ...
    <div class="field__input-wrapper">
        <input placeholder="Postal code" autocomplete="billing postal-code" autocorrect="off" data-backup="zip" class="field__input field__input--zip" aria-required="true" size="30" type="text" name="checkout[billing_address][zip]" id="checkout_billing_address_zip" />
    </div>
</div>
    ...
    <input type="hidden" name="checkout[total_price]" id="checkout_total_price" value="101900" autocomplete="off" />
    <input type="hidden" name="complete" value="1" autocomplete="off" />

    <div class="shown-if-js">
      <button name="button" type="submit" id="continue_button" class="step__footer__continue-btn btn" aria-busy="false"><span class="btn__content" data-continue-button-content="true">Complete order</span><svg class="icon-svg icon-svg--size-18 btn__spinner icon-svg--spinner-button" aria-hidden="true" focusable="false"> <use xlink:href="#spinner-button" /> </svg></button>
  ...
  <span class="visually-hidden" id="checkout-context-step-one">
    Customer information - astor - Checkout
  </span>
</div>
...
<h1 class="visually-hidden">
  ...
  <div class="product-thumbnail__wrapper">
    <img alt="New Watch Series Black - 128GB / magenta" class="product-thumbnail__image" src="//cdn.shopify.com/s/files/1/0023/4104/4283/products/28_b79dc524-d48e-404d-8384-0358251f2d03_small.png?v=1643625211" />
  </div>
    <span class="product-thumbnail__quantity" aria-hidden="true">1</span>
          ...
          <th class="product__description" scope="row">
            <span class="product__description__name order-summary__emphasis">New Watch Series Black</span>
          ...
          <td class="product__price">
            <span class="order-summary__emphasis skeleton-while-loading">$999.00</span>
          </td>
        </tr>
      </tbody>
    </table>
...
<div class="visually-hidden" data-order-summary-section="accessibility-live-region">
  ...
  <div id="partial-icon-symbols" class="icon-symbols" data-tg-refresh="partial-icon-symbols" data-tg-refresh-always="true"><svg xmlns="http://www.w3.org/2000/svg"><symbol id="warning"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 22"><path d="M15.286 2.386l7.91 13.857C25.01 19.423 23.65 22 20.16 22H3.84C.35 22-1.01 19.427.805 16.243l7.91-13.857c1.815-3.178 4.754-3.185 6.57 0zm-1.737.992c-1.05-1.838-2.05-1.837-3.1 0L2.54 17.235C1.468 19.122 1.93 20 3.84 20h16.32c1.91 0 2.374-.88 1.298-2.765l-7.91-13.857zM12 6.5c.552 0 1 .448 1 1V12c0 .552-.448 1-1 1s-1-.448-1-1V7.5c0-.552.448-1 1-1zm-1.5 10c0-.828.666-1.5 1.5-1.5.828 0 1.5.666 1.5 1.5 0 .828-.666 1.5-1.5 1.5-.828 0-1.5-.666-1.5-1.5z"/></svg></symbol>
