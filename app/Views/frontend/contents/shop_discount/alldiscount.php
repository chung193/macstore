                     ...
                     <div class="single-sidebar-widget mb-40">
                        ...
                        <div class="widget-post-wrapper">
                           ...
                           <div class="single-widget-post">
                              ...
                              <div class="content">
                                 <h3 class="widget-post-title"><a href="<?= $val['slug']?>"><?= $val['title']?></a></h3>
                     ...
                     <div class="col-lg-12 col-md-12 col-sm-6 col-12  mb-60">
                        <div class="single-slider-post">
                           <div class="single-slider-post__image mb-30">
                              <a href="<?= base_url().'/khuyen-mai/'.$val['slug']?>"> 
                              <img id="bannerImage-11720491067" class="lazyautosizes lazyloaded" 
                              src="<?= base_url().'/public/uploads/discount/'.$val['banner']?>" data-src="<?= base_url().'/public/uploads/discount/'.$val['banner']?>" data-sizes="auto" alt="" sizes="690px"></a> 
                           </div>
                           <div class="single-slider-post__content">
                              ...
                              <h2 class="post-title"><a href="<?= $val['slug'] ?> "><?= $val['title'] ?> </a></h2>
                              <p class="post-excerpt"><?= $val['description'] ?> </p>
                              <a class="blog-readmore-btn" href="<?= base_url().'/khuyen-mai/'.$val['slug'] ?>">Đọc thêm</a> 
                           </div>
                        </div>
                     </div>
