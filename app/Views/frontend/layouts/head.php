<head>
  ...
  <style>
    ...
    *,
    ...
    .overlay-navigation-active .overlay-navigation-menu-container nav>ul>li>a span.sale,
    ...
    .overlay-navigation-active .overlay-navigation-menu-container nav>ul>li>a span.sale::before,
  ...
  <style rel="stylesheet">
    ...
    .recent_view_product__content input[disabled].astor-button.astor-button--medium {
    ...
    .five-column .img_variant,
    .grid-list .img_variant,
    .three-column .img_variant,
    .four-column .img_variant,
      {
      width: 30px;
      height: 30px;
    }
  ...
  <link href="//cdn.shopify.com/s/files/1/0023/4104/4283/t/6/assets/theme-settings.css" rel="stylesheet" type="text/css" media="all">
